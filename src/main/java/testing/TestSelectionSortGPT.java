...
import algorithms.SelectionSortGPT;
...
public class TestSelectionSortGPT {
    ...
    private final Sorter<Integer> sorter = new SelectionSortGPT<>();
    ...
    public static void main(String[] args) throws RunnerException {
        OptionBuilder.getRunner(TestSelectionSortGPT.class.getName()).run();
