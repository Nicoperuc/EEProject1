...
import algorithms.QuickSortGPT;
...
public class TestQuickSortGPT {
    ...
    private final Sorter<Integer> sorter = new QuickSortGPT<>();
    ...
    public static void main(String[] args) throws RunnerException {
        OptionBuilder.getRunner(TestQuickSortGPT.class.getName()).run();
