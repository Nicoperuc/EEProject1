...
public class TestBubbleSortWhileNeeded {
    ...
    private final Sorter<Integer> sorter = new BubbleSortWhileNeeded<>();
    ...
    public static void main(String[] args) throws RunnerException {
        OptionBuilder.getRunner(TestBubbleSortWhileNeeded.class.getName()).run();
